...
import com.example.myapplication.RecyclerViewHolder.TopPokemonViewHolder;
...
public class TopPokemonViewAdapter extends RecyclerView.Adapter<TopPokemonViewHolder> implements Filterable
{
    private ArrayList<Top100Pokemon> mPokemonList;
    private ArrayList<Top100Pokemon> mPokemonListFull;
    public ArrayList<String> rankNumber;
    private Context mContext;
    private Users user;

    public TopPokemonViewAdapter(ArrayList<Top100Pokemon> pokemonList, Users user, Context context, ArrayList<String> rankNum)
    {
    ...
    @NonNull
    @Override
    public TopPokemonViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_toppokemon, parent, false);
        TopPokemonViewHolder svh = new TopPokemonViewHolder(view);
        return svh;
    }

    //Setting text and images
    @Override
    public void onBindViewHolder(@NonNull TopPokemonViewHolder holder, int position)
    {

        final Pokemon currentPokemon = mPokemonList.get(position);
        holder.rank.setText(rankNumber.get(position));
        ...
        holder.topPokemon.setOnClickListener(new View.OnClickListener() {
    ...
    private Filter pokemonFilter = new Filter() {
        ...
        {
            mPokemonList.clear();
            mPokemonList.addAll((ArrayList<Top100Pokemon>)filterResults.values);
            notifyDataSetChanged();
        }
    };

    public void setTypeColor(@NonNull TopPokemonViewHolder holder, Pokemon currentPokemon)
    {
